...
親は、子の判断が第1判断→第2判断で変わった人数と、第2判断→最終判断で変わった人数の合計を得点します。

子は、第2判断→最終判断で自分が変えた場合は「更新点」として 1 点を得ます。変えなかった場合は、他の子のうち第2判断→最終判断で変え、かつ最終判断が自分と同じになった人数ぶんを「引き込み点」として数え、1人につき 2 点を得ます。
